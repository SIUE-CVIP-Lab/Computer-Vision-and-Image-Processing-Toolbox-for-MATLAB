function d = pattern_tanimoto_cvip(file_tt, file_tr)
% PATTERN_TANIMOTO_CVIP – takes two csv files as input,test and training set, 
% then calculates the Tanimoto similarity metric by comparing each vector
% in the test set to each in the training set.
%
% Syntax :
% ------
...
% Description :
% -----------  
% Using Tanimoto similarity metric we calculate the distance between the vectors 
...
% Revision History
 % Revision 1.3  02/16/2019  15:13:53  
 % debug problem in Tanimoto formula that put twice the square of the Test
 % vector instead of use the Train vector
%
