function d = pattern_maximum_cvip(file_tt, file_tr)
% PATTERN_MAXIMUM_CVIP – takes two csv files as input, test and training
% set, then calculates the maximum value distance metric by comparing each
