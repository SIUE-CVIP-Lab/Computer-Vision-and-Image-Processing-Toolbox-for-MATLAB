function d = pattern_minkowski_cvip(file_tt, file_tr, r)
% PATTERN_MINKOWSKI_CVIP – takes two csv files as input, test and training 
% set, then calculates the minkowski distance metric by comparing each
...
% Description :
% -----------
% Using minkowski metric we calculate the distance between the vectors 
% in training set and the test set.The minkowsi metric has an extra argument r
% which needs to be given as the last input.The distances are returned in a matrix
...
%                   A CSV file with a predefined structure.
%  'r'              The parameter for mikowski distance metric. 
...
%                   d = pattern_minkowski_cvip(file_tt, file_tr,3)
%
% Reference
% ---------
...
% Revision History
 % Revision 1.3  02/16/2019  16:49:48
 % adding absolute value in subtraction of vector in order to avoid roots
 % of negative numbers.
%
