function [fData, OutIma, time] = btcenco2_cvip(InIma,Blk)
% BTCENCO2_CVIP - Encodes an input image using Block truncation Coding and
%                the given Block size. Improved - Uses Char notation (Fast)
%  
% Syntax :  
% ------
% [fData, OutIma, time] = btcenco2_cvip(InIma,Blk)
%
% Description :
% -----------
...
%                [fileData, OutIma, t] = btcenco2_cvip(InIma,Blk); 
...
%
%
%  See also, btcdeco_cvip, btcenco_cvip, btcdecol_cvip, btcencol_cvip,
    ...
    for band = 1:b
        for VBlk = 1:nVBlk
            for HBlk = 1:nHBlk
                ...
                Stream = char((b0(:)>=mb)+48)';%get bitstream
                Siza = size(Stream,2);
