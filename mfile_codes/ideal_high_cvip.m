function out_s = ideal_high_cvip( spectrum, block_size, transform_type, keep_DC, fc )
...
%   out_s = ideal_high_cvip( spectrum, [], 'fft', 32 );   
%   figure; imshow(out_s,[]);   
%   out_s = ideal_high_cvip( spectrum, [64 128], 'non-fft', 32 );   
%   figure; imshow(out_s,[]);  
%   out_s = ideal_high_cvip( spectrum, [64 128], 'center', 16 );  
%   figure; imshow(out_s,[]);
% 
% 
% Reference :
...
H = ideal_h_cvip( 'high', block_size, origin, keep_DC, fc );
