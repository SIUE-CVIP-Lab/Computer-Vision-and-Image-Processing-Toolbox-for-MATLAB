function Y = simple_wiener_filter_cvip(d,h,cutoff,limitGain,noiseImage,originalImage,K)
...
%      noiseIm = imread('cam_noise.bmp');
%      figure;imshow(originalImage);
%      figure;imshow(noiseIm);
%      figure;imshow(d); 
%      h = [ 2.50 4.500 2.250 :4.500 9.001 4.500 : 2.250 4.500 2.250];
%      limitGain = 10;
%      cutoff = 32;
%      k =  0.6;
%      Y = simple_wiener_filter_cvip(d,h,cutoff,limitGain,noiseIm,originalImage,k);
