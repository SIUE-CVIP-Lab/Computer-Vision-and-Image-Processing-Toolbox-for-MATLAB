function out_s = ideal_bandreject_cvip( spectrum, block_size, transform_type,  keep_DC,  fc_low, fc_high )
% IDEAL_BANDREJECT_CVIP  - perform ideal bandreject filtering.
%
% Syntax :
% ------
% out_s = ideal_bandreject_cvip( spectrum, block_size, transform_type, fc )
%
...
%   out_s = ideal_bandreject_cvip( spectrum, [], 'fft', 32 , 45);
%   figure; imshow(out_s,[]);
%   out_s = ideal_bandreject_cvip( spectrum, [64 128], 'non-fft', 32, 55 );
%   figure; imshow(out_s,[]);
%   out_s = ideal_bandreject_cvip( spectrum, [64 128], 'center', 16,32 );
%   figure; imshow(out_s,[]);
%       
% Reference
% ---------
...
H = ideal_h_cvip( 'br', block_size, origin, keep_DC, fc_low, fc_high );
